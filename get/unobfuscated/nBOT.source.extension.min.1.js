...
function toggleBadWordsFilter(){
	...
	if(window.nbot_badWordsFilterEngine == 1){
		...
		$.post("https://www.origem-bot.tk/get/actions/action_4daf4ds8g.php", {
...
function talk_getAnswer(from, w) {
	$.get("https://www.origem-bot.tk/ai/getAnswer.php", {
		word: w
	}, function(reply) {
...
function dcLookUp(username, uid, rurl, nfmsg) {
	...
	$.post(
		"https://www.origem-bot.tk/get/actions/action_sdg54s65dg98.php", {
...
function ulozitWaitList() {
	...
	$.post(
		"https://www.origem-bot.tk/get/actions/action_s8d4g1s56g.php", {
...
if(typeof(zistiAktivituBota) == "function") {
	...
	$.post("https://www.origem-bot.tk/get/actions/loader.php", {
			Room: encodeURIComponent(document.URL),
			Key: rurl
		},
		...
		function(data) {
			...
			if(window.nbot_odpoved !== "Failed") {
				...
				$("#nBOT-ControlContent").append('' +
					...
					'<div class="logoIcon" style="display:table-cell; vertical-align:middle;width:200px;border-left:1px solid black;padding:5px 10px"><img src="https://www.origem-bot.tk/img/logo_white.png" style="height:50px;"></div>' +
					'</div>' +
				...
				$("#nBOT-ArtificialIntelligence").append('' +
					...
					'</div>' +
					'</div>' +
					'<div class="inpanel_infobox">Read more about AI here:<br><a href="https://www.origem-bot.tk/#ai" target="_blank">https://www.origem-bot.tk/#ai</a></div>'+
					'<input type="submit" class="nSubmit" value="' + window.nbot_nLANG.panel_settings_0_4_5 + '">' +
					'</div>' +
					'</form>' +
				...
				if(window.nbot_findLangCode !== 0) {
					...
					detectedLanguage = '<div class="polozka">' +
						'<div class="label">' + window.nbot_nLANG.panel_settings_0_3_2 + '<br><a href="https://www.origem-bot.tk/langs/new.php" target="_blank" class="nSubmit">New private language</a></div>' +
						'</div>';
					$("#nBOT-LanguageEditor").append('' +
						'<div class="panelHeader" style="background:#1c1f25;height:60px;margin-bottom:20px">' +
						'<div class="closeIcon" onClick="skrytControlPanel(\'nBOT-LanguageEditor\')" style="vertical-align:top;cursor:pointer;width:30px;display:table-cell;padding:15px;height:30px;"><i class="icon icon-arrow-right"></i></div>' +
				...
				$("#nbot-passwordchange-form").submit(function() {
					$.post("https://www.origem-bot.tk/get/actions/change_password.php", {
				...
				$("#cookies_form").submit(function() {
					$.post("https://www.origem-bot.tk/get/actions/action_xc59rGy1x.php", {
	...
	(function() {
		...
		settings = (function() {
			...
			settings.prototype.pupScriptUrl = 'https://www.origem-bot.tk/get/nBOT.start.extension.js';
						...
						if(window.nbot_talk_engine_type == "private"){
							...
							$.getJSON(window.nbot_talk, function(reply) {
								...
								if(reply.onMention &&
									...
									$.getJSON("https://rawgit.com/CikerDeveloper/NBOT/master/default_ai.json", function(r){
		...
		checkActiveBot = function() {
			$.post(
				"https://www.origem-bot.tk/get/actions/loader.php", {
					Room: encodeURIComponent(document.URL),
					Key: rurl
...
*/
		songban = (function(_super) {
			...
			songban.prototype.functionality = function() {
				...
				$.post(
					"https://www.origem-bot.tk/get/actions/action_89rhsds54dg.php", {
						name: eAuthor,
						title: eTitle,
						eURL: document.URL,
						videoKey: eKey,
...
*/
		songunban = (function(_super) {
			...
			songunban.prototype.functionality = function() {
				...
				$.post(
					"https://www.origem-bot.tk/get/actions/action_as454hf8h.php", {
						SongCode: code,
						eURL: document.URL,
						key: rurl
					},
		...
		download = (function(_super) {
			...
			download.prototype.functionality = function() {
				...
				if(window.nbot_downloading == 0) {
					...
					$.get("https://www.origem-bot.tk/get/userPoints.php", {
						userID: uid
					}, function(reply) {
						if(reply > (Math.round((API.getMedia().duration * 0.09) * 100) / 100)) {

							$.post("https://www.origem-bot.tk/online-download/download.php", {
								...
								$.get("https://www.origem-bot.tk/online-download/download.php", {
									dv: (API.getMedia().cid)
								}, function(s) {
									window.nbot_downloading = 0;
								});
...
*/
		fb = (function(_super) {
			...
			fb.prototype.functionality = function() {
				...
				$.post("https://www.origem-bot.tk/get/actions/action_f9as54g89e.php", {
						BotName: "NarcisBOT",
						Version: "1",
						Room: encodeURIComponent(document.URL),
						g: "fb",
...
*/
		...
		handleNewSong = function(obj) {
			...
			if(data.currentsong === null) {
				...
				$.post(
					"https://www.origem-bot.tk/get/actions/action_2a1fsas98s.php", {
	...
	function checkBanned() {
		...
		$.post(
			"https://www.origem-bot.tk/get/actions/action_x879af1d56g.php", {
				videoKey: eKey,
				url: document.URL
			},
	...
	function updateLivePLay() {
		...
		if(typeof API.getDJ() !== "undefined") {
			...
			roomName = encodeURIComponent($("#room-name").children().text());
			$.post(
				"https://www.origem-bot.tk/get/actions/action_4daf4ds8g.php", {
					eAuthor: author,
					eTitle: title,
	...
	function saveSongToDatabase(author, title, dj, w, g, m, key, euid) {
		...
		$.post(
			"https://www.origem-bot.tk/get/actions/action_9a8s7f9as4f5.php", {
				eAuthor: author,
				eTitle: title,
				eDJ: dj,
				eUid: euid,
